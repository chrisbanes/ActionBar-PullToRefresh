...
public class PullToRefreshAttacher implements View.OnTouchListener {
	...
	/**
	 * Set the {@link HeaderViewListener}
	 * 
	 * @param listener
	 */
	...
	/**
	 * A simple listener that gets notified when the pull to refresh actionbar
	 * header view is shown or has been removed
	 * 
		...
		public void onRefreshMinimized() {
			...
			if (mContentLayout != null) {
				mContentLayout.startAnimation(AnimationUtils.loadAnimation(
						mContentLayout.getContext(), R.anim.fade_out));
